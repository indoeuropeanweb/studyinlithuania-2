         ...
         <div className='py-10 px-5'>
              ...
              <div className='mt-10'>
               ...
               <div className='my-10'>
                      ...
                      <p className='font-inter text-base text-justify'>Lithuania has become one of Europe&#39;s most popular study destinations for international
                ...
                <div className="my-10">
                  <div className="mb-10">
                    ...
                    <p className="text-gray-600 mt-3 text-base">
                      ...
                      and excellent opportunities for international students.
                    </p>
                  </div>
                  ...
                  <div className="grid grid-cols-2 lg:grid-cols-3 gap-5">
                    ...
                    <div className="bg-white border rounded-2xl p-6 text-center shadow-sm hover:shadow-lg transition">
                      ...
                      <h3 className="text-3xl font-bold text-primary">Multiple</h3>
                      <p className="mt-2 text-gray-600">
                  ...
                  <div className="mt-10 bg-primary text-white rounded-2xl p-8">
                    <p className="text-center text-lg leading-relaxed">
                      ...
                      life-changing international experience.
                    </p>
                  </div>
                </div>
         </div>
