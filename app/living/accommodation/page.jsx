  ...
  return (
    <>
        ...
        <div className='px-5 py-10'>
          ...
          <p className='text-md font-roboto mt-3'>Finding comfortable accommodation is an important part of preparing for student life in
            ...
            <div className='mt-5'>
              ...
              <div className='mt-5'>
                ...
                <p className='mt-2 text-inter text-md'>Many Lithuanian universities provide on-campus or nearby student dormitories for international
              ...
              <div className='mt-5'>
                ...
                <p className='mt-2 text-inter text-md'>Shared flats are another popular option among international students in Lithuania. Students
                ...
                <p className='mt-3 text-inter text-md font-medium'>Shared accommodation usually includes:</p>
                <ul className='space-y-2 mt-2'>
                ...
                <p className='text-inter text-md my-5'>Before finalising accommodation, students should always check rental terms, transportation
                access, and nearby facilities.</p>
              </div>
            </div>
            <div className='mt-5'>
              <h4 className='font-roboto text-xl md:text-2xl'>Comfortable Student Life in Lithuania</h4>
              <p className='font-inter text-md mt-3'>Universities in Lithuania also support international students with accommodation guidance
