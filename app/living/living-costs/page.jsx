  ...
  return (
    <>
        ...
        <div className='px-5 py-10'>
          ...
          <p className='text-md font-roboto mt-3'>Understanding the living cost in Lithuania is an important part of planning your study abroad journey. Lithuania is considered one of the more affordable European destinations, offering a good balance between quality education and reasonable lifestyle expenses for international students.<br />
            ...
            <div className='mt-5'>
              <div className='mt-5'>
                ...
                <p className='mt-2 text-inter text-md'>Housing is the biggest part of a student’s budget in Lithuania. Students can choose between university dormitories, shared apartments, or private rentals.</p>
                ...
                <p className='text-inter text-md my-5'>Living in university accommodation also allows students to interact with classmates and
              ...
              <div className='mt-5'>
                ...
                <p className='mt-2 text-inter text-md'>Food expenses in Lithuania are quite manageable for students. Most universities also have cafeterias that offer affordable meal options.</p>
                <ul className='space-y-2 mt-2'>
                ...
                <p className='text-inter text-md my-5'>Students who cook at home can reduce their monthly food expenses even further.</p>
              </div>
            </div>
              <div className='mt-5'>
                <h5 className='font-roboto text-lg md:text-xl'>Transportation Cost in Lithuania</h5>
                <p className='mt-2 text-inter text-md'>Public transport in Lithuania is well-connected and affordable for students. Cities like Vilnius and Kaunas offer student discounts on monthly transport passes.</p>
                <ul className='space-y-2 mt-2'>
                ...
                <p className='text-inter text-md my-5'>Many students prefer public transport or cycling, as most facilities are located within easy reach</p>
              </div>
              <div className='mt-5'>
                <h5 className='font-roboto text-lg md:text-xl'>Lifestyle, Entertainment & Personal Expenses</h5>
                <p className='mt-2 text-inter text-md'>Apart from basic needs, students also spend on entertainment, social life, and personal activities. Lithuania offers a balanced student lifestyle with reasonable costs.</p>
                <ul className='space-y-2 mt-2'>
                ...
                <p className='text-inter text-md my-5'>Students can comfortably enjoy social activities without putting too much pressure on their budget.</p>
              </div>
            <div className='mt-5'>
              <h4 className='font-roboto text-xl md:text-2xl'>Final Overview</h4>
              <p className='font-inter text-md mt-3'>Overall, Lithuania offers an affordable and student-friendly cost of living compared to many other European countries. With proper budgeting, students can easily manage their monthly expenses while enjoying a comfortable and active student life in Europe.</p>
            </div>
        </div>
    </>
  )
