          ...
          <p className='text-md font-roboto mt-3'>Lithuania is becoming a preferred destination for international students not only because of affordable education but also because of growing career opportunities. International students in Lithuania are allowed to work while studying, helping them gain professional experience and manage their living expenses during their education journey.<br /><br />Students can work part-time during their studies as long as their job does not affect academic performance. Many students successfully balance studies and work by choosing flexible jobs and managing their schedules properly.</p>
            ...
            <div className='mt-5'>
              ...
              <div className='mt-2'>
                ...
                <p className='text-inter text-md my-5'>Students studying business, IT, engineering, and healthcare may also find career-related internships during their studies.</p>
              </div>
              <div className='mt-5'>
                <h5 className='font-roboto text-lg md:text-xl'>Average Salary and Working Hours</h5>
                <p className='mt-2 text-inter text-md'>The salary in Lithuania depends on the type of work, skills, and working hours. Many students work part-time to support accommodation, food, and personal expenses while studying abroad.</p>
                <p className='mt-2 text-inter text-md'>International students can usually manage both studies and work comfortably with proper time management. However, universities always recommend prioritising academic performance during the study period.</p>
              </div>
              <div className='mt-5'>
                <h5 className='font-roboto text-lg md:text-xl'>How to Find Jobs in Lithuania</h5>
                <p className='mt-2 text-inter text-md'>International students can search for jobs through:</p>
                <ul className='space-y-2 mt-2'>
                ...
                <p className='text-inter text-md my-5'>Creating a professional CV and preparing for interviews can improve job opportunities for students in Lithuania.</p>
              </div>
              <div className='mt-5'>
                <h5 className='font-roboto text-lg md:text-xl'>Career Support for International Students</h5>
                <p className='mt-2 text-inter text-md'>Many universities in Lithuania provide career guidance and student support services to help international students prepare for future careers.</p>
                <p className='mt-3 text-inter text-md'>University career services may include:</p>
                <ul className='space-y-2 mt-2'>
                ...
                <p className='text-inter text-md my-5'>These services help students improve professional skills and connect with employers during their studies.</p>
              </div>
              <div className='mt-5'>
                <h5 className='font-roboto text-lg md:text-xl'>Work Opportunities After Graduation</h5>
                <p className='mt-2 text-inter text-md'>Lithuania also offers career opportunities for international graduates after completing their studies. Students may explore jobs in sectors such as:</p>
                <ul className='space-y-2 mt-2'>
                ...
                <p className='text-inter text-md my-5'>Graduates who find suitable employment opportunities may apply for further residence and work-related permissions according to Lithuanian immigration regulations.</p>
              </div>
              <div className='mt-5'>
                <h5 className='font-roboto text-lg md:text-xl'>Important Guidelines for Students</h5>
                <p className='mt-2 text-inter text-md'>Before starting work in Lithuania, students should:</p>
                <ul className='space-y-2 mt-2'>
                ...
                <p className='text-inter text-md my-5'>Working legally and responsibly helps students gain valuable international work experience while staying protected under Lithuanian employment laws.</p>
              </div>
            </div>
            <div className='mt-5'>
              <h4 className='font-roboto text-xl md:text-2xl'>Build Your Career in Lithuania</h4>
              <p className='font-inter text-md mt-3'>Studying and working in Lithuania can provide students with international exposure, practical experience, and career growth opportunities. With affordable living costs, growing industries, and student-friendly policies, Lithuania offers a supportive environment for students planning their future in Europe.</p>
            </div>
        </div>
    </>
  )
